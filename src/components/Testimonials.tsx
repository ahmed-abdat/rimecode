...
const Testimonials = () => {
  return (
    <section className="relative py-8 bg-white dark:bg-black" id="testimonials">
      <div className="pt-16 md:pt-24"></div>
      <div className="container mx-auto px-4">
        <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-center mb-8 bg-clip-text text-transparent bg-gradient-to-r from-blue-500 to-purple-500">
