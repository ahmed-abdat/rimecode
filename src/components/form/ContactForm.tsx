...
const formSchema = z.object({
  ...
  inquiryNature: z.enum(["Sales", "Support", "Partnership", "Other"]),
  additionalDetails: z
    .string()
      ...
      <AnimatePresence mode="wait">
        {!isSubmitted ? (
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem className="space-y-2">
                      <FormLabel className="text-gray-700 dark:text-gray-300">Nature of the inquiry</FormLabel>
                      <Select onValueChange={field.onChange} defaultValue={field.value}>
                        ...
                        <SelectContent className="bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-600 rounded-lg shadow-lg ">
                          <SelectItem value="Sales" className="p-3 hover:bg-gray-100 dark:hover:bg-gray-700">Sales</SelectItem>
                          <SelectItem value="Support" className="p-3 hover:bg-gray-100 dark:hover:bg-gray-700">Support</SelectItem>
                          <SelectItem value="Partnership" className="p-3 hover:bg-gray-100 dark:hover:bg-gray-700">Partnership</SelectItem>
                          <SelectItem value="Other" className="p-3 hover:bg-gray-100 dark:hover:bg-gray-700">Other</SelectItem>
                        </SelectContent>
                      </Select>
                      <FormMessage className="text-red-500" />
                    </FormItem>
          ...
          <motion.div
            ...
            className="text-center p-8 bg-gradient-to-br from-green-50 to-blue-50 dark:from-green-900 dark:to-blue-900 rounded-lg shadow-lg"
          >
            <motion.div
              initial={{ scale: 0 }}
              animate={{ scale: 1 }}
              ...
              className="mb-6"
            >
              <CheckCircle2 className="w-16 h-16 mx-auto text-green-500 dark:text-green-400" />
            </motion.div>
            <motion.h3
